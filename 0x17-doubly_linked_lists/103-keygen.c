 ...
 *
 * @usrn: Points to theusername
 * @len: lThis is the length of username
 * Return: gives the biggest number
 */
...
/**
 * f5 -this  multiplies each char of username
 *
 * @usrn: point to the username
 * @len: represents the length of username
 * Return: gives the multiplied char
 */
...
/**
 * f6 - this generates a random char
 *
